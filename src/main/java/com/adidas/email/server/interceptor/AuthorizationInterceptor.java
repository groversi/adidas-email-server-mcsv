package com.adidas.email.server.interceptor;

import com.adidas.email.server.exceptions.dto.ApiErrorResponseDTO;
import com.adidas.email.server.services.AuthenticationService;
...
public class AuthorizationInterceptor extends OncePerRequestFilter implements Filter {
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        String jwtAuthToken = request.getHeader(AUTH_HEADER_AUTHORIZATION);
        ...
        Boolean authorized = authenticationService.validateJwtToken(jwtAuthToken.replace(AUTH_HEADER_PREFIX, ""));
        if(authorized)
